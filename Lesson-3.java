...
public class Main {
    ...
    static void enterTheNameAndNumber() {
        ...
        System.out.printf("Aloha, %s! Can you try to guess the number I set? You have only 3 attempts.", name);
        System.out.println();
    }

    //Рандомно выбираем число, которое загадал компьютер
    static int rollRandomNumber() {
        return (int) (Math.random() * 10);
    }

    //Создаем цикл-угадайку
        ...
        do {
            for (int i = 0; i < attempt; i++) {
                ...
                if ((i - 1) > 0) {
                    ...
                    System.out.println("Guessed number was: " + rollRandomNumber);
                }
            }
